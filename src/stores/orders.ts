...
export const useOrdersStore = defineStore('orders', () => {
  const orders = ref<Order[]>([
    { id: 'ORD-1001', items: [], customer: { name: 'Sara Ahmed',    email: 'sara@example.com',   phone: '+971501234567', address: '12 Sheikh Zayed Rd', city: 'Dubai', zip: '00000' }, subtotal: 18.00, shipping: 0,    total: 18.00, status: 'delivered', date: '2026-06-01' },
    ...
    { id: 'ORD-1003', items: [], customer: { name: 'Layla Nour',    email: 'layla@example.com',  phone: '+971503456789', address: '33 Jumeirah St',     city: 'Dubai', zip: '00000' }, subtotal: 22.75, shipping: 0,    total: 22.75, status: 'preparing', date: '2026-06-14' },
    ...
    { id: 'ORD-1005', items: [], customer: { name: 'Fatima Al Ali', email: 'fatima@example.com', phone: '+971505678901', address: '88 Marina Walk',     city: 'Dubai', zip: '00000' }, subtotal: 31.25, shipping: 0,    total: 31.25, status: 'pending',   date: '2026-06-20' },
    { id: 'ORD-1006', items: [], customer: { name: 'Sara Ahmed',    email: 'sara@example.com',   phone: '+971501234567', address: '12 Sheikh Zayed Rd', city: 'Dubai', zip: '00000' }, subtotal: 11.00, shipping: 0,    total: 11.00, status: 'delivered', date: '2026-06-05' },
    { id: 'ORD-1007', items: [], customer: { name: 'Sara Ahmed',    email: 'sara@example.com',   phone: '+971501234567', address: '12 Sheikh Zayed Rd', city: 'Dubai', zip: '00000' }, subtotal: 25.50, shipping: 0,    total: 25.50, status: 'delivered', date: '2026-06-15' },
    ...
    { id: 'ORD-1010', items: [], customer: { name: 'Omar Faris',    email: 'omar@example.com',   phone: '+971504567890', address: '5 Downtown Blvd',    city: 'Dubai', zip: '00000' }, subtotal: 19.50, shipping: 0,    total: 19.50, status: 'delivered', date: '2026-06-15' },
    { id: 'ORD-1011', items: [], customer: { name: 'Fatima Al Ali', email: 'fatima@example.com', phone: '+971505678901', address: '88 Marina Walk',     city: 'Dubai', zip: '00000' }, subtotal: 15.00, shipping: 0,    total: 15.00, status: 'delivered', date: '2026-06-12' },
    { id: 'ORD-1012', items: [], customer: { name: 'Reem Sultan',   email: 'reem@example.com',   phone: '+971506789012', address: '44 Jumeirah Beach', city: 'Dubai', zip: '00000' }, subtotal: 12.50, shipping: 2.99, total: 15.49, status: 'delivered', date: '2026-06-20' },
    { id: 'ORD-1013', items: [], customer: { name: 'Ahmed Rashid',  email: 'ahmed@example.com',  phone: '+971507890123', address: '9 Business Bay',    city: 'Dubai', zip: '00000' }, subtotal: 22.00, shipping: 0,    total: 22.00, status: 'delivered', date: '2026-06-21' },
